...
$english = array(
		...
		// Menu items and titles
			...
			'tidypics:mostviewed' => 'Most viewed photos',
                        'tidypics:mostviewed:nosucess' => 'No photos were viewed on this site yet.',
		...
		//settings
			...
			'tidypics:settings:photo_ratings' => "Enable photo ratings (requires Elggx Fivestar plugin or compatible)",
